...
### Sommersemester 2023 - Intake 2020B
...
<iframe width="1000" height="550" src="https://www.youtube.com/embed/HRILg3916oQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
* .bold[Inhaltliche Kompetenzen]:
    ...
    * Mikro- und Makroökonomische Erklärungen von Marktergebnissen, Rolle von Institutionen
    * Vergleich ausgewählter internationaler Märkte (institutionenökonomischer Ansatz)


--

* .bold[Methodenkompetenzen]:
  * Einordnung von Marktentwicklungen und Ableitung von strategischen Handlungsalternativen
  * Rolle der Rahmenbedingungen und Ableitung strategischer Handlungskonzepte
...
* .bold[Fachübergreifende Kompetenzen]:
  ...
  * Interdependenz von Immobilien- und Kapitalmärkten
...
* Modul: Immobilienmärkte
  * Teilmodul: Staat und Immobilienmarkt
  * Teilmodul: Internationale Immobilienmärkte
* Leistungspunkte für das Modul: Immobilienmärkte: 
	4 ECTS, je 2 ECTS für die beiden Teilmodule

* Workload:
  * Je 20 Stunden Präsenzunterricht 
  * Je 40 Stunden Selbststudium (Hausaufgaben, Literatur und Recherchen)
  
* Prüfungsleistung: kombinierte Prüfungsleistung:
  * Continuous Assessment (mindestens 3 Präsentationen)
  * Projektarbeit (Modul) als Gruppenarbeit
      * Umfang 2500-3000 Wörter
      * Aspekte aus beiden Teilmodulen
...
knitr::include_graphics('../images/session1/978-3-319-32031-1.webp')
```
]
.pull-right[
```{r, echo=FALSE,fig.align='center',out.width="95%"}
knitr::include_graphics('../images/session1/978-3-030-49032-4.webp')
```
]
...
knitr::include_graphics('../images/session1/roadmap_Intake2020B.PNG')
```

<br>

.pull-right[**Abgabe Projektarbeit:** 15.10.2023?]
